...
public class MonsterSpawn : MonoBehaviour
{
    ...
    {   
        ...
        if (monsterObjectPooling == null)
        {
            ...
            monsterObjectPooling.transform.localPosition = new Vector3(Random.Range(-10f, 10f), 0, Random.Range(-10f, 10f));
            monsterObjectPooling.transform.eulerAngles = new Vector3(0, Random.Range(0f, 360f), 0);
